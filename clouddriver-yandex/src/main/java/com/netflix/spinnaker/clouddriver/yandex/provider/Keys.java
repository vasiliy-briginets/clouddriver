...
public class Keys implements KeyParser {
  ...
  public static Map<String, String> parse(String key) {
    ...
    switch (namespace) {
      ...
      case SUBNETS:
        ...
        result.put("folder", parts[3]);
        result.put("name", parts[4]);
        break;
      case IMAGES:
        result.put("account", parts[2]);
        result.put("id", parts[3]);
        result.put("folder", parts[4]);
  ...
  // todo: добавить везде account - иначе будут чужие показываться!
  ...
  public static String getNetworkKey(String id, String folderId, String name) {
    return YandexCloudProvider.ID
        + ":"
        + Namespace.NETWORKS
        + ":"
  ...
  public static String getSubnetKey(String id, String folderId, String name) {
    return YandexCloudProvider.ID
        + ":"
        + Namespace.SUBNETS
        + ":"
  ...
  public static String getLoadBalancerKey(String id, String folderId, String name) {
    return YandexCloudProvider.ID
        + ":"
  ...
  public static String getInstanceKey(String id, String folderId, String name) {
    return YandexCloudProvider.ID
        + ":"
        + Namespace.INSTANCES
        + ":"
  ...
  public static String getServerGroupKey(String id, String folderId, String name) {
    return YandexCloudProvider.ID
        + ":"
